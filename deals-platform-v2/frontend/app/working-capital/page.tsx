    ...
    <div className="p-6 space-y-4">
      ...
      <div className="panel p-3 flex flex-wrap items-center gap-x-6 gap-y-1 text-xs border border-neutral-dark-secondary">
        <div>
          ...
          <span className="ml-2 text-neutral-dark-tertiary">· higher = larger cash opportunity relative to revenue</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <div className="lg:col-span-2 space-y-2">
          ...
          <div className="text-xs text-neutral-dark-tertiary">Ranked by score (0–1). Higher score = larger working capital opportunity.</div>
          {items.map((s) => (
            <SituationCard
              key={s.id}
              s={s}
